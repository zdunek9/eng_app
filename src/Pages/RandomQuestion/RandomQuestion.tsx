...
const RandomQuestion = () =>{
    ...
    return(
        <Wrapper>
            ...
            <span>
            <MdAutorenew onClick={rollQuestion} onAnimationEnd={(e:any)=>{e.currentTarget.classList.remove("rollingItem")}}/>
            <GiConfirmed onClick={confirmQuestion} style={{color: doneItem?'green':'black'}}/>
            </span>
            <Hearth />
            </MainWrapper>
            <div>
